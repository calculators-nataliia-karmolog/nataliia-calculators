...
import './IntegrityMatrixPage.scss';
...
import { IntegrityMatrixForm } from '../../Forms/IntegrityMatrixForm';
import { MatrixIntegrity } from '../../MatrixIntegrity/MatrixIntegrity';
import { TableIntegrity } from '../../TableIntegrity/TableIntegrity';

export const IntegrityMatrixPage = () => {
      ...
      {!userDataPersonal.birth ? (
        ...
        <>
          ...
          <div className="matrix-and-big-table-wrapper">
            <MatrixIntegrity getEnergyValue={getEnergyValue} />
          ...
          <div className="table-wrapper">
            ...
            <div className="table-wrapper_btn-group">
              ...
              <a target="_blank" rel="noreferrer" href="https://nataliia-karmolog.github.io">
                <button className="btn btn_compatibility-matrix" style={{ width: 170, height: 37 }}>
                  Послуги та вартість
                </button>
              </a>
