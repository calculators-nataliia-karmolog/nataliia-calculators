...
import getFractionAgeID from '../../functions/getFractionAgeID';
...
export const Purposes = ({ getEnergyValue }: IYearsTableProps) => {
  ...
  const elementEnergy = getFractionAgeID(personalEnergyArray, userDataPersonal.ageInMonths);

  function getYearId() {
    const yearIDPlus = elementEnergy! + 40;
  ...
  useEffect(() => {
    if (parseInt(userDataPersonal.yearsOld) >= 0) {
      setFirstCircle(personalEnergyArray[elementEnergy!].toString());
      setSecondCircle(getYearId().toString());
      setThirdCircle(
        getSum(
          parseInt(secondCircle) + parseInt(personalEnergyArray[elementEnergy!].toString())
        ).toString()
      );
    } else {
      setFirstCircle('-');
        ...
        <div className="purposes_top">
          <div className="purpose personal">
            ...
            <p className="p-with-margin">
              Наші задачі на духовному та матеріальному рівні <br />
            </p>
            <div className="rect">
          ...
          <div className="purpose social">
            ...
            <p className="p-with-margin">
              ...
              <br /> яку цінність ми несемо людям <br />
            </p>
            <div className="rect">
              <div className="content">
