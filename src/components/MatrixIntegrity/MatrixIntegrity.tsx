...
export const MatrixIntegrity = ({ getEnergyValue }: IYearsTableProps) => {
  const { mainString, userDataPersonal } = useAppSelector((state) => state.storeReducer);
  // const mainString = ['2', '4', '0', '1', '1', '9', '9', '7'];
  const screenWidth = window.innerWidth;

  return (
    <div className="matrix_wrapper matrix-integrity_wrapper">
      ...
      <div className="circle circle_medium" id="medium-5">
        <div className="circle circle_medium_inside" id="medium-5_inside">
          {getSum(
            largeCircleValueCenter(mainString, userDataPersonal.birth) +
              largeCircleValue5(mainString, userDataPersonal.birth) +
              largeCircleValue5(mainString, userDataPersonal.birth)
      ...
      <div className="circle circle_medium" id="medium-8">
        <div className="circle circle_medium_inside" id="medium-8_inside">
          {mediumCircleK27(
            getSum(
              largeCircleValueCenter(mainString, userDataPersonal.birth) +
                largeCircleValue8(mainString, userDataPersonal.birth)
      ...
      <div className="circle circle_small" id="small-14">
        <div className="circle circle_small_inside" id="small-14_inside">
          {getSum(
            largeCircleValueCenter(mainString, userDataPersonal.birth) +
              getSum(
                largeCircleValueCenter(mainString, userDataPersonal.birth) +
      ...
      <div className="circle circle_small" id="small-15">
        <div className="circle circle_small_inside" id="small-15_inside">
          {getSum(
            largeCircleValueCenter(mainString, userDataPersonal.birth) +
              getSum(
                largeCircleValueCenter(mainString, userDataPersonal.birth) +
      ...
      <div className="circle circle_small" id="small-16">
        <div className="circle circle_small_inside" id="small-16_inside">
          {getSum(
            getSum(
              getSum(
                getSum(
      ...
      <div className="circle circle_small" id="small-17">
        <div className="circle circle_small_inside" id="small-17_inside">
          {getSum(
            getSum(
              getSum(
                getSum(
      ...
      <div className="circle circle_small" id="small-18">
        <div className="circle circle_small_inside" id="small-18_inside">
          {getSum(
            getSum(
              getSum(
                largeCircleValueCenter(mainString, userDataPersonal.birth) +
      ...
      <div className="circle circle_small" id="small-19">
        <div className="circle circle_small_inside" id="small-19_inside">
          {getSum(
            getSum(
              getSum(
                largeCircleValueCenter(mainString, userDataPersonal.birth) +
      ...
      <div className="dot" id="dot-44">
        <div className="years-period">62,5</div>
        <div className="energy-value" id="1">
          {getEnergyValue().sixtyTwo63Value}
        </div>
      </div>
      <div className="dot" id="dot-45">
        <div className="years-period">63,75</div>
        <div className="energy-value" id="1">
      ...
      <div className="dot" id="dot-52">
        <div className="years-period">73,75</div>
        <div className="energy-value" id="1">
