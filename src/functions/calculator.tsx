...
export const mediumCircleValue2 = (mainString: string[], birth: string) => {
  return getSum(
    largeCircleValue2(mainString, birth) +
      getSum(largeCircleValue2(mainString, birth) + largeCircleValueCenter(mainString, birth))
  );
};
...
export const mediumCircleValue3 = (mainString: string[], birth: string) => {
  return getSum(
    largeCircleValue3(mainString, birth) +
      getSum(largeCircleValue3(mainString, birth) + largeCircleValueCenter(mainString, birth))
  );
};
...
export const mediumCircleValue4 = (mainString: string[], birth: string) => {
  return getSum(
    largeCircleValue4(mainString, birth) +
      getSum(largeCircleValue4(mainString, birth) + largeCircleValueCenter(mainString, birth))
  );
};
export const mediumCircleValue5 = (mainString: string[], birth: string) => {
  return getSum(
    largeCircleValueCenter(mainString, birth) +
      getSum(largeCircleValue5(mainString, birth) + largeCircleValue5(mainString, birth))
  );
};
export const mediumCircleValue6 = (mainString: string[], birth: string) => {
  return getSum(
    largeCircleValue6(mainString, birth) +
      getSum(largeCircleValue6(mainString, birth) + largeCircleValueCenter(mainString, birth))
  );
};
export const mediumCircleValue7 = (mainString: string[], birth: string) => {
  return getSum(
    largeCircleValue7(mainString, birth) +
      getSum(largeCircleValueCenter(mainString, birth) + largeCircleValue7(mainString, birth))
  );
};
...
export const smallCircleValue2 = (mainString: string[], birth: string) => {
  return getSum(largeCircleValue2(mainString, birth) + largeCircleValueCenter(mainString, birth));
};
export const smallCircleValue3 = (mainString: string[], birth: string) => {
  return getSum(largeCircleValue3(mainString, birth) + largeCircleValueCenter(mainString, birth));
};
...
export const smallCircleValue8 = (mainString: string[], birth: string) => {
  return getSum(largeCircleValue6(mainString, birth) + largeCircleValueCenter(mainString, birth));
};
...
export const smallCircleValue10 = (mainString: string[], birth: string) => {
  return getSum(largeCircleValueCenter(mainString, birth) + largeCircleValue7(mainString, birth));
};
